...
<hr>
<article>
<div style="background: #FF000030">red</div>
<div style="background: #00FF0030">green</div>
<div style="background: #0000FF30">blue</div>
</article>
<hr>
<article>
<div style="background: rgb(255, 0, 0, 0.5)">red</div>
<div style="background: rgb(0, 255, 0, 0.5)">green</div>
<div style="background: rgb(0, 0, 255, 0.5)">blue</div>
</article>
<hr>
</body>
</html>